module go-agent-worker

go 1.25.1

require (
	github.com/cavos-io/conversation-worker v0.0.0
...
require (
	...
	github.com/livekit/protocol v1.44.1 // indirect
...
replace github.com/cavos-io/conversation-worker => ../rtp-agent
